...
<div class="wrap">
    <div id="header">
        ...
        <div id="language_tag">
            <a href="{{ route('first_floor') }}" style="text-decoration: none; color: yellow">LT</a>
        </div>
    </div>
...
{{--                </div>--}}
                ...
                <div class="big_select">
                    <select id="filter" class="form-select form-select-lg mb-3 p-3" aria-label=".form-select-lg example">
                        ...
                        <option value="relax_zone">Relax and work zones</option>
                                ...
                                <div id="calc_box_room_bullet_wrapper">
                                    ...
                                    <div class="calc_box_room_bullet_desc">
                                        ...
                                        <div class="info">
                                            ...
                                            <p>{{$pointers[3]->phone_number}}</p>
                                            <p>{{$pointers[3]->main_email}}</p>
                                            <button id="redirect_room_en1" class="pc_button" style="font-size: 0.9rem">Reservation</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div id="printing_bullet_wrapper">
                                    ...
                                    <div class="printing_bullet_desc">
                                        ...
                                        <div class="info">
                                            ...
                                            <button id="redirect_print" class="pc_button" style="font-size: 0.9rem">Services</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div id="pc_second_bullet_wrapper">
                                    ...
                                    <div class="pc_second_bullet_desc">
                                        ...
                                        <div class="info">
                                            ...
                                            <p>{{$pointers[0]->email}}</p>
                                            <p>{{$pointers[0]->main_email}}</p>
                                            <button id="redirect_pc_en_en" class="pc_button" style="font-size: 0.9rem">Library catalogue</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
